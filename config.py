...
# ==============================================================================
MODEL_BACKEND = os.getenv("PATHWISE_MODEL_BACKEND", "coco").lower()
if MODEL_BACKEND not in {"idd", "coco"}:
    raise ValueError("PATHWISE_MODEL_BACKEND must be either 'idd' or 'coco'")

MODEL_PATH = os.getenv(
    "PATHWISE_MODEL_PATH",
    "idd_model.pt" if MODEL_BACKEND == "idd" else "yolov10n.pt",
)
...
#  SYSTEM IO & DISPLAY
# ==============================================================================
VIDEO_SOURCE = int(os.getenv("PATHWISE_CAMERA_INDEX", "0"))
OUTPUT_CSV = True
OUTPUT_VIDEO = False
